...
export function ShippingZoneTable({ zones, onUpdate }: ShippingZoneTableProps) {
  ...
  const handleCreateZone = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await MerchantOperationsClient.createShippingZone('MERCHANT', {
        name: zoneName.trim(),
  ...
  const handleDeleteZone = async (zoneId: string) => {
    ...
    setLoading(true);
    try {
      await MerchantOperationsClient.deleteShippingZone('MERCHANT', zoneId);
      onUpdate();
    } catch (err) {
  ...
  const handleCreateRate = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await MerchantOperationsClient.createShippingRate('MERCHANT', {
        zoneId: activeZoneId,
        methodName,
  ...
  const handleDeleteRate = async (rateId: string) => {
    ...
    setLoading(true);
    try {
      await MerchantOperationsClient.deleteShippingRate('MERCHANT', rateId);
      onUpdate();
    } catch (err) {
